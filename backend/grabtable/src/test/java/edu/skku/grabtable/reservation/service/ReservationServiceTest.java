...
class ReservationServiceTest {
    ...
    void invitee_create_fail() {
        Reservation reservation = new Reservation(1L, null, null, null, null, null, null, ReservationStatus.ONGOING);
    ...
    void invitee_participate_fail() {
        Reservation reservation = new Reservation(1L, null, null, null, null, null, null, ReservationStatus.ONGOING);
        Reservation reservation2 = new Reservation(2L, null, null, null, null, null, null, ReservationStatus.ONGOING);
        User user = new User(1L, "kakaoUser", "url", "userA", "1234", "email", "phone", reservation, new ArrayList<>(),
                new ArrayList<>());
        Store store = new Store(1L, "storeA", "Seoul", null, "url", "phone", "desc", StoreStatus.VALID,
                StoreCategory.JAPANESE,
