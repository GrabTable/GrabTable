  ...
  return (
    <div className="flex items-end mb-4">
      <div className="grid w-full gap-1.5 mr-4">
        <Label htmlFor="invitecode">Invite people using this invitation code!</Label>
        <Textarea value={inviteCode} rows={1} id="invitecode" readOnly/>
      </div>
      <Button onClick={copyToClipboard} className="bg-black hover:bg-black/70 dark:bg-white">
        <FaRegClipboard /> Copy
      </Button>
    </div>
  )
