...
export function InputWithButton(): JSX.Element {
  ...
  return (
    <div className="flex w-full items-center space-x-2" style={{maxWidth: '100rem'}}>
    <motion.div
    ...
    >
      ...
      <Button asChild className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-105 hover:scale-105 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10">
